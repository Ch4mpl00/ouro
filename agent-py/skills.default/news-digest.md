...
**Пріоритетні теми** — користувача стосуються особисто, **завжди**
включай якщо є реальні новини:
- **ФОП:** зміни ставок єдиного податку, ЄСВ, ПДВ, нові обмеження
  на види діяльності, скасування / перегляд груп ФОП, перевірки
  ДПС, штрафи, нові форми звітності, КВЕДи, ліміти доходу. Навіть
  «законопроєкт прийнято в першому читанні» — включай, якщо це
  реально зачіпає ФОП.
- **Ухилянти / мобілізація:** санкції проти ухилянтів (блокування
  рахунків, авто, виїзду, прав, ID-карток), нові підстави для
  бронювання, зміни в системі резерв+ / Дія, перевірки ТЦК,
  штрафи за непостановку на облік, рішення судів які створюють
  прецедент. ТЦК-інциденти — лише тренди й системні зміни,
  поодинокі випадки skip.

**Інше** — включай якщо проходить значущість-бар:
прильоти й руйнування з реальною шкодою; важливі події Одеси та
України; великі кадрові / законодавчі зрушення; інфраструктурні
обмеження (світло, транспорт, перекриття); рішення про санкції
іншого роду з прямим впливом на мешканця.

*Skip:* одиничні побутові інциденти, культурно-історичні замітки,
"нардеп предложил" без просування, суперечки фракцій без наслідків,
weather, поодинокі ТЦК-випадки без тренду, курйози, tabloid.
